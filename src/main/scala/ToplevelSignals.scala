...
/**
  ...
  */
object Op1Select {
  val OP1_DC  = 0.asUInt(3.W)
  val rs1     = 1.asUInt(3.W)
  val PC      = 2.asUInt(3.W)
  val OP1_N   = 3.asUInt(3.W)
}

object Op2Select {
  val OP2_DC  = 4.asUInt(3.W)
  val rs2     = 5.asUInt(3.W)
  val imm     = 6.asUInt(3.W)
  val OP2_N   = 7.asUInt(3.W)
}
